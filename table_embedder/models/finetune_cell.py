...
class TableEmbedder(Model):
    ...
    def forward(self, table_info: Dict[str, str],
        ...
        prob_cells_for_acc = torch.stack([prob_cells_nega_1d, prob_cells_pos_1d], dim=1)
        self.metrics['accuracy'](prob_cells_for_acc, cell_labels_1d, mask=cell_mask_1d)

        # h_loss_weight = 0.0
        # loss = cell_loss * (1.0-h_loss_weight) + header_loss * h_loss_weight
        output_dict = {'loss': cell_loss}
